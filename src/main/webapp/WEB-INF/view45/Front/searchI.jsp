...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<link href="${pageContext.request.contextPath}/static/one/css/seastyle.css" rel="stylesheet" type="text/css" />

		<script type="text/javascript" src="${pageContext.request.contextPath}/static/one/basic/js/jquery-1.7.min.js"></script>
		<script type="text/javascript" src="${pageContext.request.contextPath}/static/one/js/script.js"></script>
	</head>
	...
	<body>
		...
		<div class="am-container header">
           ...
           <div class="search">
			...
			<div class="nav-table">
					...
					<div class="am-g am-g-fixed" style="margin-left: 15%" >
						<div class="am-u-sm-12 am-u-md-12">
	                  	<div class="theme-popover">														
							<div class="searchAbout">
								<span class="font-pale">相关搜索：</span>
								<span class="font-pale" id="bookSize"></span>
							</div>
                        </div>
							<div class="search-content" >
								...
								<ul class="am-avg-sm-2 am-avg-md-3 am-avg-lg-4 am-avg-lg-5  boxes" id="bookContent">
									<!--  <li>
										<div class="i-pic limit">
											<img src="${pageContext.request.contextPath}/static/one/images/imgsearch1.jpg" />
		...
		$(function(){
			...
			function getBookListByCategoryId()
			{
				var categoryId=getQueryString("categoryId");
				 $.ajax({
			            type:"POST",
			            url:"Json_getBookListByCategoryId",
			            data:{categoryId:categoryId},
			            dataType:"json",
			            success:function(data){
			            	var bookContent='';
			            	$("#bookSize").html(data.bookCategoryName+"&nbsp;&nbsp;总共有"+data.bookSize+"条记录");
			            	var bookList = data.bookList;
			            	$.each(bookList, function(i, item) {
			            			bookContent+='<li><div class="i-pic limit"><img src="${pageContext.request.contextPath}'+item.bookPicPath+'" />';
			            			bookContent+='<p class="title fl">【lny】'+item.bookName+'</p><p class="price fl"><b>¥</b>';
			            			bookContent+='<strong>'+item.bookPrice+'</strong></p>';
			            			if(item.discountRate!=1 || item.discountRate!=1.0)
			            			{
			            				bookContent+='<p class="number fl">优惠价<span>'+item.discountRate*item.bookPrice+'</span></p></div></li>';
			            			}	
				                 });
			            	$("#bookContent").html(bookContent);
			            	//alert(data.bookList);
			            	//alert(categoryId);
			            },
			            error:function(data){
